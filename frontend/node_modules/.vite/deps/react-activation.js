...
var require_lib2 = __commonJS({
  "node_modules/react-activation/lib/index.js"(exports) {
    ...
    var Keeper = function(_PureComponent) {
      function Keeper2(props) {
        ...
        _defineProperty(_this, "drop", function() {
          var _ref2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, _ref2$delay = _ref2.delay, delay = _ref2$delay === void 0 ? 1200 : _ref2$delay, _ref2$refreshIfDropFa = _ref2.refreshIfDropFailed, refreshIfDropFailed = _ref2$refreshIfDropFa === void 0 ? true : _ref2$refreshIfDropFa;
      ...
      return _createClass(Keeper2, [{
        ...
        value: function render() {
          var _this4 = this;
          var _this$props5 = this.props, id = _this$props5.id, _this$props5$autoFree = _this$props5.autoFreeze, autoFreeze = _this$props5$autoFree === void 0 ? true : _this$props5$autoFree, _this$props5$contentP = _this$props5.contentProps, contentProps = _this$props5$contentP === void 0 ? {} : _this$props5$contentP, props = _objectWithoutProperties(_this$props5, _excluded$2);
          ...
          }, React__default.createElement("div", _extends({}, contentProps, {
    ...
    function controllerCherryPick(controller) {
      var drop = controller.drop, dropScope = controller.dropScope, refresh = controller.refresh, refreshScope = controller.refreshScope, clear = controller.clear, getCachingNodes = controller.getCachingNodes, dropById = controller.dropById, dropScopeByIds = controller.dropScopeByIds, refreshById = controller.refreshById, refreshScopeByIds = controller.refreshScopeByIds;
      return {
        drop,
        dropScope,
        refresh,
    ...
    var expandKeepAlive = function expandKeepAlive2(KeepAlive2) {
      var renderContent = function renderContent2(_ref) {
        var idPrefix = _ref.idPrefix, helpers = _ref.helpers, props = _ref.props, forwardedRef = _ref.forwardedRef;
      ...
      var HookExpand = function HookExpand2(_ref2) {
        var idPrefix = _ref2.id, forwardedRef = _ref2.forwardedRef, props = _objectWithoutProperties(_ref2, _excluded$4);
        return renderContent({
          idPrefix,
      ...
      var WithExpand = function WithExpand2(_ref3) {
        var idPrefix = _ref3.id, forwardedRef = _ref3.forwardedRef, props = _objectWithoutProperties(_ref3, _excluded2);
      ...
      if (_isFunction(React.forwardRef)) {
        var ForwardedRefHOC = React.forwardRef(function(props, ref) {
          return React__default.createElement(ExpandKeepAlive, _extends({}, props, {
            forwardedRef: ref,
    ...
    var KeepAlive = function(_Component) {
      function KeepAlive2(props) {
        ...
        _defineProperty(_this, "refresh", function() {
          var _this$props3 = _this.props, _helpers = _this$props3._helpers, id = _this$props3.id;
          return _helpers.refreshById(id);
        });
        _defineProperty(_this, "drop", function(config) {
          var _this$props4 = _this.props, _helpers = _this$props4._helpers, id = _this$props4.id;
          return _helpers.dropById(id, config);
        });
        _defineProperty(_this, "init", function() {
          var _this$props5 = _this.props, _helpers = _this$props5._helpers, id = _this$props5.id, children = _this$props5.children, rest = _objectWithoutProperties(_this$props5, _excluded$5);
        ...
        [LIFECYCLE_ACTIVATE, LIFECYCLE_UNACTIVATE].forEach(function(lifecycleName) {
          _this[lifecycleName] = function() {
            var _this$props6 = _this.props, id = _this$props6.id, _helpers = _this$props6._helpers;
            var cache = _helpers.getCache(id);
      ...
      return _createClass(KeepAlive2, [{
        ...
        key: "componentWillUnmount",
        value: function componentWillUnmount() {
          var _this$props7 = this.props, id = _this$props7.id, _helpers = _this$props7._helpers, _this$props7$when = _this$props7.when, calcWhen = _this$props7$when === void 0 ? true : _this$props7$when;
          var cache = _helpers.getCache(id);
        ...
        value: function render() {
          var _this2 = this;
          var _ref2 = this.props || {}, _ref2$wrapperProps = _ref2.wrapperProps, wrapperProps = _ref2$wrapperProps === void 0 ? {} : _ref2$wrapperProps;
    ...
    function SSRKeepAlive(_ref3) {
      ...
      var _ref4 = this.props || {}, _ref4$wrapperProps = _ref4.wrapperProps, wrapperProps = _ref4$wrapperProps === void 0 ? {} : _ref4$wrapperProps, _ref4$contentProps = _ref4.contentProps, contentProps = _ref4$contentProps === void 0 ? {} : _ref4$contentProps;
      return React__default.createElement("div", _extends({}, wrapperProps, {
        key: "keep-alive-placeholder",
        className: "ka-wrapper ".concat(wrapperProps.className || "")
      }), React__default.createElement("div", _extends({}, contentProps, {
